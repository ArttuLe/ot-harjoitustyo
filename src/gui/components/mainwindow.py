...
class Ui_Sudoku(object):
    def setupUi(self, Sudoku):
        ...
        self.set_difficulty.setGeometry(QtCore.QRect(10, 190, 171, 41))
        self.set_difficulty.setObjectName("set_difficulty")
        self.open_sudoku = QtWidgets.QPushButton(self.centralwidget)
        self.open_sudoku.setGeometry(QtCore.QRect(10, 250, 171, 41))
        ...
        self.check_sudoku.setGeometry(QtCore.QRect(400, 480, 161, 51))
        ...
        self.solve_button.setGeometry(QtCore.QRect(200, 480, 161, 51))
    ...
    def retranslateUi(self, Sudoku):
        ...
        self.solve_button.setText(_translate("Sudoku", "Solve"))
